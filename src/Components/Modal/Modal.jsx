        ...
        <Modal.Body id="heloworld"  className="text-center shadow-lg rounded-5">
          <Card >
            <div className="copy my-4">
              <button className="rounded-pill px-5 py-2 copy-btn fw-bold">Copy manager link</button>
            </div>
            <div className="my-4">
              <button className="delete-btn rounded-pill px-5 py-2 fw-bold">Delete Establishment</button>
            </div>
          </Card>
        </Modal.Body>
      </Modal>
